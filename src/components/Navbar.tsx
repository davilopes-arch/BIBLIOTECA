    ...
    <header className="space-y-2.5">
      ...
      <div className="flex items-center justify-between gap-3 pt-0.5">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <span className="text-[11px] font-semibold text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-950/50 border border-orange-200 dark:border-orange-900 px-2 py-0.5 rounded-full shrink-0">
            {totalTutorialsCount} {totalTutorialsCount === 1 ? 'item' : 'itens'}
          </span>
        </div>
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-semibold rounded-lg bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors cursor-pointer shadow-2xs"
            title="Exportar Manual em PDF"
          >
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors cursor-pointer shadow-2xs"
            ...
            <>
              {isSuperAdmin(user) && (
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 py-1.5 text-xs font-semibold rounded-lg bg-neutral-900 dark:bg-neutral-100 text-white dark:text-neutral-900 hover:bg-orange-600 dark:hover:bg-orange-500 dark:hover:text-white transition-colors cursor-pointer"
              ...
              {canUserCreateTutorial(user) && (
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 py-1.5 text-xs font-semibold rounded-lg bg-orange-600 text-white hover:bg-orange-700 transition-colors cursor-pointer"
      ...
      <div className="flex flex-col sm:flex-row gap-2 items-stretch sm:items-center">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Buscar por título, tag, autor ou conteúdo..."
            className="w-full pl-9 pr-16 py-2 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl text-xs sm:text-sm text-neutral-900 dark:text-neutral-100 placeholder:text-neutral-400 focus:outline-none focus:border-orange-500 transition-colors shadow-2xs"
          />
          {filters.query ? (
            <button
              onClick={() => onUpdateFilters({ query: '' })}
              className="absolute right-2.5 top-1/2 -translate-y-1/2 p-1 text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-200 cursor-pointer"
            >
              <X className="w-3.5 h-3.5" />
            </button>
          ) : (
            <kbd className="absolute right-2.5 top-1/2 -translate-y-1/2 px-1.5 py-0.5 text-[10px] font-mono text-neutral-400 bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded pointer-events-none">
              /
            </kbd>
          )}
        </div>
        ...
        <div className="flex items-center gap-1.5 shrink-0 overflow-x-auto pb-0.5 sm:pb-0 scrollbar-none">
          {/* Favorites Filter */}
          <button
            onClick={() => onUpdateFilters({ onlyFavorites: !filters.onlyFavorites })}
            className={`flex items-center gap-1.5 px-2.5 py-2 text-xs font-medium rounded-xl border transition-colors cursor-pointer whitespace-nowrap shadow-2xs ${
              filters.onlyFavorites
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none flex items-center gap-1 pl-2.5 pr-7 py-2 text-xs font-medium rounded-xl bg-white dark:bg-neutral-900 text-neutral-700 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-800 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors cursor-pointer shadow-2xs focus:outline-none focus:border-orange-500"
            >
          ...
          <button
            ...
            className={`flex items-center gap-1 px-2.5 py-2 text-xs font-medium rounded-xl border transition-colors cursor-pointer whitespace-nowrap shadow-2xs ${
          ...
          {hasActiveFilters && (
            <button
              ...
              className="flex items-center gap-1 px-2 py-2 text-xs text-red-600 dark:text-red-400 hover:underline cursor-pointer whitespace-nowrap"
            >
              <X className="w-3 h-3" />
              <span>Limpar</span>
            </button>
